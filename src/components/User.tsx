...
function User(props: UserProps) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      firstName: Yup.string().required("First Name Reguired"),
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <Grid item xs={8}>
          <TextField
            ...
            onChange={formik.handleChange}
            error={
              formik.touched.address?.line &&
              Boolean(formik.errors.address?.line)
            }
            helperText={
              formik.touched.address?.line && formik.errors.address?.line2
            }
          />
        </Grid>
        <Grid item xs={8}>
